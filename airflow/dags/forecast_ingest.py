...
import os, requests, psycopg2, pandas as pd
...
def ingest_forecast():
    ...
    cur.executemany("""
      ...
      VALUES (%s,%s,%s,%s,%s,%s);
    """, list(df[["city","model_run","valid_time","temperature_2m","precipitation","wind_speed_10m"]]
...
with DAG(
    ...
    t1 = PythonOperator(task_id="ensure_schema_and_table", python_callable=ensure_schema_and_table)
